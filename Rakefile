...
Rake::RDocTask.new(:rdoc) do |rdoc|
  rdoc.rdoc_dir = 'rdoc'
  rdoc.options << '--title' << 'Lumberjack Graylog Device' << '--line-numbers' << '--inline-source' << '--main' << 'README.rdoc'
...
spec_file = File.expand_path('../lumberjack_graylog_device.gemspec', __FILE__)
